...
#if 0	// Changed Linphone code - Removed searchBar
...
#if 0	// Changed Linphone code - Don't know what this code is used for but it causes issues if chat list is empty but call log is not empty
