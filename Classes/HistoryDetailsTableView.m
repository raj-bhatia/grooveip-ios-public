...
- (void)loadDataForAddress:(const LinphoneAddress *)peer {
	...
	if (peer) {
#if 0	// Changed Linphone code - Old code did not work consistently
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	LOGD(@"HistoryDetailsTableView - tableView: Duration %d CallTime %ld Outgoing %d Missed %d", duration, callTime, outgoing, linphone_call_log_get_status(log));
