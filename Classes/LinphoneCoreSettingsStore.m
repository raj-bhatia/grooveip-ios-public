...
- (void)transformLinphoneCoreToKeys {
...
#if 0	// Changed Linphone code - Video calling is not supported
	// video section
	{
	...
	// call section
	{
		[self setInteger:[lm lpConfigIntForKey:@"routing_pref"
									 inSection:@"sip"
								   withDefault:0]
				  forKey:@"routing_preference"];
...
- (BOOL)synchronize {
	@try {
		...
		// call section
			[lm lpConfigSetInt:[self integerForKey:@"routing_preference"]
						forKey:@"routing_pref"
					 inSection:@"sip"];
