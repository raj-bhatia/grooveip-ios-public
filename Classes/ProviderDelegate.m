...
#if 0	// Changed Linphone code - Use a different CallKit icon
	config.iconTemplateImageData = UIImagePNGRepresentation([UIImage imageNamed:@"callkit_logo"]);
#else
	config.iconTemplateImageData = UIImagePNGRepresentation([UIImage imageNamed:@"callkit_image_grooveip"]);
#endif
