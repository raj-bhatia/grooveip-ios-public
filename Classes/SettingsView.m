...
#if 0	// Changed Linphone code - Change wording of warning message
																		 message:NSLocalizedString(@"Are you sure to want to remove your proxy setup?", nil)
#else
																		 message:NSLocalizedString(@"Are you sure you want to remove your account information?", nil)
#endif
																  preferredStyle:UIAlertControllerStyleAlert];
	...
	if (error != nil) {
		...
		[picker setToRecipients:[NSArray
									arrayWithObjects:[LinphoneManager.instance lpConfigStringForKey:@"debug_popup_email"
																						withDefault:@""],
													 nil]];
#if 0	// Changed Linphone code - Change wording of message
		[picker setMessageBody:NSLocalizedString(@"Here are information about an issue I had on my device.\nI was "
												 @"doing ...\nI expected Linphone to ...\nInstead, I got an "
#else
		[picker setMessageBody:NSLocalizedString(@"Here is information about an issue I had on my device.\nI was "
												 @"doing ...\nI expected GrooVe IP to ...\nInstead, I got an "
#endif
												 @"unexpected result: ...",
