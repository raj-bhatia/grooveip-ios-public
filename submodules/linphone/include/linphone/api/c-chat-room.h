...
LINPHONE_PUBLIC LinphoneChatMessage* linphone_chat_room_create_message_incoming(LinphoneChatRoom *cr, const char* message);
LINPHONE_PUBLIC LinphoneChatMessage* linphone_chat_room_create_message_incoming_url(LinphoneChatRoom *cr, const char* message, const char *url);
#endif
