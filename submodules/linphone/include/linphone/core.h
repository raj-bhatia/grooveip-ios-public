...
/**
 * For call routing preference
**/
LINPHONE_PUBLIC void linphone_core_set_routing_preference(LinphoneCore *lc, int routing);
LINPHONE_PUBLIC int linphone_core_get_routing_preference(LinphoneCore *lc);
