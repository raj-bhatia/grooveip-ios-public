...
LINPHONE_PUBLIC void snrblabs_report_call_log(LinphoneCore *lc, char *number, char *name, int direction, int duration, long startTime, long connectTime, int status, char *callId);
