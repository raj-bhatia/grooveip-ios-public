...
LINPHONE_PUBLIC void linphone_proxy_config_set_snrblabs_email(LinphoneProxyConfig *cfg, const char * value);

LINPHONE_PUBLIC const char * linphone_proxy_config_get_snrblabs_email(const LinphoneProxyConfig *cfg);

LINPHONE_PUBLIC void linphone_proxy_config_set_snrblabs_userid(LinphoneProxyConfig *cfg, const char * value);

LINPHONE_PUBLIC const char * linphone_proxy_config_get_snrblabs_userid(const LinphoneProxyConfig *cfg);

LINPHONE_PUBLIC void linphone_proxy_config_set_snrblabs_token(LinphoneProxyConfig *cfg, const char * value);

LINPHONE_PUBLIC const char * linphone_proxy_config_get_snrblabs_token(const LinphoneProxyConfig *cfg);

LINPHONE_PUBLIC void linphone_proxy_config_set_snrblabs_devicetoken(LinphoneProxyConfig *cfg, const char * value);

LINPHONE_PUBLIC const char * linphone_proxy_config_get_snrblabs_devicetoken(const LinphoneProxyConfig *cfg);

LINPHONE_PUBLIC void linphone_proxy_config_set_snrblabs_currency(LinphoneProxyConfig *cfg, int value);

LINPHONE_PUBLIC int linphone_proxy_config_get_snrblabs_currency(const LinphoneProxyConfig *cfg);
