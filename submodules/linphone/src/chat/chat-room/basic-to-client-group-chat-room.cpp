...
shared_ptr<ChatMessage> BasicToClientGroupChatRoom::createChatMessageIncoming () {
	shared_ptr<ChatMessage> msg = ProxyChatRoom::createChatMessageIncoming();
	msg->getPrivate()->setChatRoom(getSharedFromThis());
	return msg;
}

shared_ptr<ChatMessage> BasicToClientGroupChatRoom::createChatMessageIncoming (const string &text) {
	shared_ptr<ChatMessage> msg = ProxyChatRoom::createChatMessageIncoming(text);
	msg->getPrivate()->setChatRoom(getSharedFromThis());
	return msg;
}
#endif
