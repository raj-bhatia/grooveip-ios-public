...
shared_ptr<ChatMessage> ProxyChatRoom::createChatMessageIncoming () {
	L_D();
	return d->chatRoom->createChatMessageIncoming();
}

shared_ptr<ChatMessage> ProxyChatRoom::createChatMessageIncoming (const string &text) {
	L_D();
	return d->chatRoom->createChatMessageIncoming(text);
}
#endif
